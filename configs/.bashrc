...
# Dont need to source both, just the second seems to work, from catkin_ws
...
export ROS_IP=`hostname -I` # set own ros ip environment variable
...
alias rosinit="source /home/mike/catkin_ws/devel/setup.bash"
alias condainit="source /home/mike/anaconda3/etc/profile.d/conda.sh && conda activate"
PROMPT_DIRTRIM=2 # Shorten dir displayed to last two directories. Cooresponds to :\w in PS1
